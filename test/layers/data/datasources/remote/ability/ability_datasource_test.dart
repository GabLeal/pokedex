...
void main() {
  ...
  final abilityDetailsDatasource = AbilityDetailsDatasourceImp(httpClient);

  test('should return AbilityDetails', () async {
    when(() => httpClient.get(any())).thenAnswer(
      (_) async => HttpResponse(url: url, body: json, statusCode: 200),
    );
...
var json = {
  ...
  "flavor_text_entries": [
    ...
    {
      "flavor_text":
          "Quando si è in difficoltà, potenzia\nle mosse di tipo Erba.",
      "language": {
        "name": "it",
    ...
    {
      "flavor_text":
          "Augmente la puissance des capacités de type Plante\ndu Pokémon quand il a perdu une certaine quantité\nde PV.",
      "language": {
        "name": "fr",
        "url": "https://pokeapi.co/api/v2/language/5/"
      },
    ...
    {
      "flavor_text":
          "Potencia los movimientos de tipo Planta del Pokémon\ncuando le quedan pocos PS.",
      "language": {
        "name": "es",
        "url": "https://pokeapi.co/api/v2/language/7/"
      },
    ...
    {
      "flavor_text":
          "Quando il Pokémon ha pochi PS, la potenza delle\nsue mosse di tipo Erba aumenta.",
      "language": {
        "name": "it",
        "url": "https://pokeapi.co/api/v2/language/8/"
      },
